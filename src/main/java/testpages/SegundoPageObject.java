...
public class SegundoPageObject extends CommonElementPageObject
{
    ...
    {
        moverRaton(driver.getDriver().findElement(By.xpath("//a[contains(@href,'smartbank')][1]")));
    }

    public void hacerClickEnResultado()
    {
        click(driver.getDriver().findElement(By.xpath("//a[contains(text(),'Resultados') and contains(@href,'smartbank')][1]")));
    }
}
